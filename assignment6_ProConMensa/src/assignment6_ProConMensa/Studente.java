...
public class Studente implements Runnable {
	...
	public void run() {
			...
			System.out.println(assignment6.getOrario() + " ["+this.nome+"] Uso piatto ["+daUsare.getNome()+"]!");
			...
			System.out.println(assignment6.getOrario() + " ["+this.nome+"] Consegno piatto ["+daUsare.getNome()+"] ed esco!");
